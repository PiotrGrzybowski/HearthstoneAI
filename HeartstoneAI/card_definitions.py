...
agent_squire.abilities[DIVINE_SHIELD] = partial(abilities.apply_divine_shield)
...
divine_favor.abilities['draw_cards'] = partial(abilities.draw_cards_to_match_opponent)
...
seal_of_champions.abilities['add_attack_and_shield'] = partial(abilities.add_ability_and_specs_to_own_minion,
                                                               ability={DIVINE_SHIELD: partial(abilities.apply_divine_shield)},
                                                               attack=3)

steward_of_darshire = Minion(name=STEWARD_OF_DARKSHIRE, cost=3, abilities=dict(), attack=3, health=3, minion_type=None)
steward_of_darshire.abilities[DIVINE_SHIELD] = partial(abilities.apply_divine_shield)
